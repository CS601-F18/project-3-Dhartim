...
{
	private static HashMap<String, List<WrapperFrequency>> invertedIndex = new HashMap<>();
	...
	//	System.out.println(term);
		...
		{
			//System.out.println("inside if" + invertedIndex.containsKey(term));
			if(sortedterms.contains(term))
			{
				//System.out.println(sortedterms.contains(term));
